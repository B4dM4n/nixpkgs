{ lib, stdenv, apacheHttpd, autoconf, automake, autoreconfHook, curl, fetchFromGitHub, glib, lasso, openssl, pkg-config, xmlsec }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ apacheHttpd curl glib lasso openssl xmlsec ];
